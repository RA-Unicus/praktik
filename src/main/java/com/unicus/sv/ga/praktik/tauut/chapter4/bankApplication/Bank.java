package com.unicus.sv.ga.praktik.tauut.chapter4.bankApplication;

import com.unicus.sv.ga.praktik.tauut.chapter4.bankService.BankService;
import com.unicus.sv.ga.praktik.tauut.chapter4.bankService.Banking;
import static com.unicus.sv.ga.praktik.tauut.chapter4.bankService.Banking.AccountType.*;
import com.unicus.sv.ga.praktik.tauut.chapter4.bankService.Customer;
import com.unicus.sv.ga.praktik.tauut.chapter4.notificationService.*;
...
public class Bank {
    ...
    /**
     * Creates a new bank when provided with the required banking and
     * notification services.
     *
     * @param bankService service for holding customer information and
     * performing bank transactions
     * @param notificationService service for notifying customers of account
     * activity
     */
